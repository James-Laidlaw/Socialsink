...
urlpatterns = [
    ...
    path("api/get-old-inbox-info/", views.getOldInboxInfo, name="getOldInboxInfo"),
    path("api/get-new-inbox-info/", views.getNewInboxInfo, name="getNewInboxInfo"),
    path("api/like-post/<int:id>", views.likePost, name="likePost"),
    path("api/unlike-post/<int:id>", views.unlikePost, name="unlikePost"),
    path("api/get-post-data/", views.getPostData, name="getPostData"),
